...
import { NestedEnumDeliveryPortWithAggregatesFilter } from './nested-enum-delivery-port-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumDeliveryPortFilter } from './nested-enum-delivery-port-filter.input';

@InputType()
export class EnumDeliveryPortWithAggregatesFilter {
